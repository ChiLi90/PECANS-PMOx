    ...
    def write_output(self, output_file_name=None):
        ...
        with ncdf.Dataset(output_file_name, mode='w', clobber=True, format='NETCDF4') as ncdat:
            ...
            for name, conc in self._chemical_species.items():
                ...
                this_var[:] = conc
            if (self._seconds_since_model_start / 3600>9):
                print(self._chemical_species['NO'][0]/2.e10, self._chemical_species['NO2'][0]/2.e10, self._chemical_species['O3'][0]/2.e10, \
                      (self._chemical_species['HO'][0]+self._chemical_species['HO2'][0])/2.e10, self._chemical_species['NO2'][0]/2.e10+self._chemical_species['NO'][0]/2.e10,\
                      self._chemical_species['NO2'][0]/2.e10+self._chemical_species['O3'][0]/2.e10,self._chemical_const_species['rVOC'][0]*3.e-11)
